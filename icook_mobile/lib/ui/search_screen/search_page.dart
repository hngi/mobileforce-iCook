  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: ListView(
          children: <Widget>[_searchBar(), _recentSearch(context), _relatedSerach()],
        ),
      ),
    );
  }
...
Widget _recentSearch(context) => Container(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: ListView(
              ...
              children: <Widget>[
                _recentdish(context,'assets/images/1.png', 'Fried Rice'),
                _recentdish(context,'assets/images/2.png', 'Okro Soup'),
                _recentdish(context,'assets/images/4.png', 'Peanut butter'),
                _recentdish(context,'assets/images/3.png', 'Fufu'),
                _recentdish(context,'assets/images/1.png', 'Fried Rice'),
              ],
            ),
          )
...
Container _recentdish(BuildContext context, String image, String dish) => Container(
      margin: EdgeInsets.only(right: 10),
      child: GestureDetector(
        onTap: (){
          Navigator.pushNamed(context, ViewRoutes.detail);
        },
        child: Column(
...
class SearchResult extends StatefulWidget {
  Recipe recipe;
  SearchResult({Key key, @required context,  @required this.recipe}) : super(key: key);
  @override
