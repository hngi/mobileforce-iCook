...
class GetDIshByIdResponse {
  ...
  GetDIshByIdResponse copyWith({
    String status,
    String error,
    Data data,
  }) {
    return GetDIshByIdResponse(
  ...
  static GetDIshByIdResponse fromMap(Map<String, dynamic> map) {
  ...
  static GetDIshByIdResponse fromJson(String source) =>
      fromMap(json.decode(source));

  @override
  String toString() =>
      'GetDIshByIdResponse(status: $status, error: $error, data: $data)';

  @override
  bool operator ==(Object o) {
    if (identical(this, o)) return true;

    return o is GetDIshByIdResponse &&
        o.status == status &&
        o.error == error &&
        o.data == data;
  }
...
class Dish {
  ...
  @override
  String toString() {
    return 'Dish(dishImages: $dishImages, recipe: $recipe, ingredients: $ingredients, healthBenefits: $healthBenefits, id: $id, name: $name, chefId: $chefId, createdAt: $createdAt, updatedAt: $updatedAt, v: $v, commentsCount: $commentsCount, likesCount: $likesCount, isLiked: $isLiked, isFavourite: $isFavourite)';
  }
