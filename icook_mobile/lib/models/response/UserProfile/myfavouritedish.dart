...
class MyFavouriteDishesResponse {
  final String status;
  final String error;
  final Data data;
  MyFavouriteDishesResponse({
    this.status,
    this.error,
    this.data,
  });

  MyFavouriteDishesResponse copyWith({
    String status,
    String error,
    Data data,
  }) {
    return MyFavouriteDishesResponse(
  ...
  static MyFavouriteDishesResponse fromMap(Map<String, dynamic> map) {
  ...
  static MyFavouriteDishesResponse fromJson(String source) =>
      fromMap(json.decode(source));

  @override
  String toString() =>
      'MyFavouriteDishesResponse(status: $status, error: $error, data: $data)';

  @override
  bool operator ==(Object o) {
    if (identical(this, o)) return true;

    return o is MyFavouriteDishesResponse &&
        o.status == status &&
        o.error == error &&
        o.data == data;
  }
...
class Dishe {
  ...
  @override
  String toString() {
    return 'Dishe(dishImages: $dishImages, recipe: $recipe, ingredients: $ingredients, healthBenefits: $healthBenefits, id: $id, name: $name, chefId: $chefId, createdAt: $createdAt, updatedAt: $updatedAt, v: $v, commentsCount: $commentsCount, likesCount: $likesCount, isLiked: $isLiked)';
  }
